...
<template>
    ...
    <div class="flex items-end justify-between mb-4">
        ...
        dark:hover:bg-slate-800 px-2 py-1 rounded-md">
            ...
            <label for="toggleRole" class="block text-sm font-medium text-slate-700 
            dark:text-slate-300 cursor-pointer">Show suspended users</label>
        </div>
    </div>
    ...
    <table class="bg-white dark:bg-slate-800 w-full rounded-lg overflow-hidden ring-1 ring-slate-300">
        ...
        <tbody class="divide-y divide-slate-300 divide-dashed">
            <tr v-for="user in users.data" :key="user.id" class="hover:bg-slate-100 dark:hover:bg-slate-700">
