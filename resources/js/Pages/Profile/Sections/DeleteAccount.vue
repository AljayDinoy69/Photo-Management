    ...
    <Container class="mb-6">
        ...
        <div v-if="show">
            <form @submit.prevent="submit" class="flex items-end gap-4">
                ...
                <button @click="show = false" class="text-indigo-500 font-medium underline dark:text-indigo-400">Cancel</button>
            </form>
        </div>

        <button v-if="!show" @click="show = true" class="px-6 py-2 rounded-lg bg-red-500 text-white">
